...
return (
  <div className="p-4 sm:p-6">
    ...
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4 sm:mb-6">
      ...
      <Headline className="text-xl sm:text-2xl font-bold">All Tasks</Headline>
    </div>
    ...
    <div className="flex flex-col sm:flex-row sm:flex-wrap gap-3 sm:gap-4 mb-4 sm:mb-6">
      <input
        ...
        className="p-2 text-sm sm:text-base rounded w-full sm:w-auto sm:flex-1 sm:max-w-xs"
      />
      ...
      <Label className="w-full sm:w-auto">
        <select
          ...
          className="w-full p-2 rounded text-sm sm:text-base bg-[#3d3d47]"
        >
    ...
    {filteredTasks.length === 0 ? (
      <p className="text-sm sm:text-base text-gray-500">No tasks match your criteria.</p>
    ) : (
      <ul className="space-y-3 sm:space-y-4">
        {filteredTasks.map((task) => (
          <li key={task.id} className="list-none">
            <Card className="p-3 sm:p-4 flex flex-col gap-2 shadow-sm w-full">
              ...
              <Body2>
                <div className="text-gray-500 text-xs sm:text-sm flex flex-col sm:flex-row sm:gap-2">
                  ...
                  <span className="hidden sm:inline">|</span>
                  <span className="whitespace-nowrap">Category: {task.category}</span>
                </div>
              </Body2>
              ...
              <div className="flex gap-4 sm:gap-6 mt-1">
                ...
                <button
                  ...
                  className="text-red-600 underline cursor-pointer text-sm sm:text-base"
                >
                  Delete
                </button>
              </div>
